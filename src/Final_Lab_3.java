...
public class Final_Lab_3 extends Applet{
		...
		public void paint(Graphics g){
			 ...
			 */
			for(int c = 0; c < col_to_gen; c++){
				for(int r = 0; r < rows_to_gen; r++){
					g.setColor(body);
					g.fillRect(body_x + (face_w * c), body_y + (face_h * r) + (body_h * r), body_w, body_h);		
					g.setColor(face);
					g.fillOval(face_x + (face_w * c), face_y + (face_h * r) + (body_h * r), face_w, face_h);
					g.setColor(insideface);
					g.drawArc(smile_x + (face_w * c), smile_y + (face_h * r) + (body_h * r), smile_w, smile_h, smile_arcangle, smile_arglength);
					g.fillOval(left_eye_x + (face_w * c), left_eye_y + (face_h * r) + (body_h * r), left_eye_w, left_eye_h);
					g.fillOval(right_eye_x + (face_w * c), right_eye_y + (face_h * r) + (body_h * r), right_eye_w, right_eye_h);
				}// End of rows_to_gen
			}// End of for col_to_gen
		}// End of paint method
}// End of class
